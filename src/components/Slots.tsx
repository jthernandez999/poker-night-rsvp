...
const Slots: React.FC<SlotsProps> = ({ 
  ...
  setShowL 
    ...
    >
            ...
            <div
                className={`absolute z-30 -translate-x-[40px] -translate-y-[20px] md:-translate-x-[120px] md:-translate-y-[15px] max-w-[386px] md:max-w-[800px] self-center min-w-[320px] md:min-w-[384px] ${
                    leverPull
            ...
            <div className='h-24 w-24 md:h-32 md:w-max flex z-40 absolute -translate-x-2 md:translate-x-40 -translate-y-[128px] md:-translate-y-56'>
                <Image 
                    draggable={false} 
                    className='' 
                    src="/dice2.png" 
