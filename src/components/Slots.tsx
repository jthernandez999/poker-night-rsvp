  ...
  function rand() {
      ...
      if (approved == true) {
          ...
          const winningTable: Array<{
              ...
              { probability: 0.003, combination: "FROG-FROG-FROG", multiplier: 10, symbols: ['frog', 'frog', 'frog'] },
              { probability: 0.008, combination: "DIAMOND-DIAMOND-DIAMOND", multiplier: 8, symbols: ['diamond', 'diamond', 'diamond'] },
