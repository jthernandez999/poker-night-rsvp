...
const Slots: React.FC<SlotsProps> = ({ 
  ...
  setShowL 
    ...
    >
            ...
            <div
                className={`absolute z-30 -translate-x-[40px] -translate-y-[128px] xs:-translate-y-[150px] sm:-translate-y-[10px] md:-translate-x-[115px] md:-translate-y-[15px] max-w-[386px] md:max-w-[800px] self-center min-w-[320px] md:min-w-[384px] ${
                    leverPull
