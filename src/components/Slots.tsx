...
const Slots: React.FC<SlotsProps> = ({ 
  ...
  setShowL 
    ...
    >
            ...
            <div
                className={`absolute z-30 -translate-x-[40px] -translate-y-[40px] md:-translate-x-[120px] md:-translate-y-[15px] max-w-[386px] md:max-w-[800px] self-center min-w-[320px] md:min-w-[384px] ${
                    leverPull
