...
const Slots: React.FC<SlotsProps> = ({ 
  ...
  setShowL 
    ...
    >
            ...
            <div
                className={`absolute z-30 -translate-x-[40px] -translate-y-[0px] md:-translate-x-[105px] md:-translate-y-[15px] max-w-[386px] md:max-w-[800px] self-center min-w-[320px] md:min-w-[384px] ${
                    leverPull
            ...
            <div className='h-28 w-28 md:h-max md:w-max  flex z-40 absolute translate-x-0 md:translate-x-[156px] translate-y-20 md:translate-y-[156px]'>
                {" "}
                <Image 
                    draggable={false} 
                    src="/dice1.png" 
